 ...
 */
package net.sseongsu.test.widget;
...
public class TouchForwardLayout extends FrameLayout {
	...
	public boolean onInterceptTouchEvent(MotionEvent ev) {
		...
		Toast.makeText(getContext(), "intercept", Toast.LENGTH_SHORT).show();
		return true;
	}
	...
	public boolean onTouchEvent(MotionEvent event) {
		...
		Toast.makeText(getContext(), "onTouch " + event.getAction(), Toast.LENGTH_SHORT).show();
